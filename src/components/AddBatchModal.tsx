    ...
    >
      <div className="bg-white rounded-xl shadow-xl w-full max-w-md mx-4">
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h2 id="add-batch-modal-title" className="text-xl font-semibold text-gray-900">Create New Batch</h2>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            <label htmlFor="product-name" className="block mb-1.5 text-sm font-medium text-gray-700">Product Name</label>
            <input
              id="product-name"
              type="text"
              value={product}
          ...
          <div>
            <label htmlFor="production-line" className="block mb-1.5 text-sm font-medium text-gray-700">Production Line</label>
            <select
              id="production-line"
              value={lineId}
          ...
          <div>
            <label htmlFor="batch-quantity" className="block mb-1.5 text-sm font-medium text-gray-700">Quantity</label>
            <input
              id="batch-quantity"
              type="number"
              value={quantity}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor="batch-status" className="block mb-1.5 text-sm font-medium text-gray-700">Status</label>
              <select
                id="batch-status"
                value={status}
            ...
            <div>
              <label htmlFor="quality-status" className="block mb-1.5 text-sm font-medium text-gray-700">Quality</label>
              <select
                id="quality-status"
                value={qualityStatus}
          ...
          <div className="flex items-center justify-end space-x-3 pt-4 border-t border-gray-200">
            ...
            <button
              type="submit"
              disabled={loading}
              aria-label={loading ? 'Creating batch' : 'Create new production batch'}
