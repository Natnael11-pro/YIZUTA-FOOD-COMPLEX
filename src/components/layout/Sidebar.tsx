...
// ✅ FIX 1: Define the props interface so TypeScript knows 'userRole' is allowed
...
const Sidebar = ({ userRole }: SidebarProps) => {
  ...
  return (
    // ✅ ACCESSIBILITY: Added aria-label to the sidebar container
    <aside className="fixed left-0 top-0 h-screen w-64 bg-white border-r border-gray-200 flex flex-col" aria-label="Application Sidebar">
      {/* Logo Section */}
      ...
      {/* ✅ ACCESSIBILITY: Added aria-label to the navigation menu */}
          ...
          menuItems.map((item) => {
            ...
            return (
              <button
                ...
                // ✅ ACCESSIBILITY: Added aria-current to tell screen readers which page is active
      ...
      <div className="p-4 border-t border-gray-200">
        <div className="flex items-center mb-3">
          <div className="w-10 h-10 rounded-full bg-blue-600 flex items-center justify-center text-white font-semibold" aria-hidden="true">
        ...
        {/* ✅ ACCESSIBILITY: Added aria-label to the sign-out button */}
        <button
